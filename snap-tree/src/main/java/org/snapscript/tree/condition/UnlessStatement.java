...
public class UnlessStatement implements Compilation {

   private final Statement branch;

   public UnlessStatement(Evaluation evaluation, Statement positive) {
      this(evaluation, positive, null);
   }

   public UnlessStatement(Evaluation evaluation, Statement positive, Statement negative) {
