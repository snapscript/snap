...
lib.PreferenceManager.prototype.diff = function (a, b) {
    ...
    if ((typeof a) !== (typeof b) || !(/^(undefined|boolean|number|string)$/.test(typeof a))) {
        return true;
    }
...
hterm.Keyboard.KeyMap.prototype.onKeyHome_ = function (e) {
    if (!this.keyboard.homeKeysScroll ^ e.shiftKey) {
        if ((e.altey || e.ctrlKey || e.shiftKey) || !this.keyboard.applicationCursor) {
            return '\x1b[H';
        }
...
hterm.Keyboard.KeyMap.prototype.onKeyEnd_ = function (e) {
    if (!this.keyboard.homeKeysScroll ^ e.shiftKey) {
        if ((e.altKey || e.ctrlKey || e.shiftKey) || !this.keyboard.applicationCursor) {
            return '\x1b[F';
        }
...
hterm.PreferenceManager.defaultPreferences = {
    'alt-gr-mode': [hterm.PreferenceManager.categories.Keyboard, null,
    ...
    'alt-sends-what': [hterm.PreferenceManager.categories.Keyboard, 'escape',
    ...
    'environment': [hterm.PreferenceManager.categories.Miscellaneous, {'TERM': 'xterm-256color'},
        'value',
    ...
    'mouse-paste-button': [hterm.PreferenceManager.categories.CopyPaste, null,
        [null, 0, 1, 2, 3, 4, 5, 6],
...
hterm.Screen.prototype.insertString = function (str) {
    ...
    if (reverseOffset < 0) {
        ...
        if (!(this.textAttributes.underline ||
            ...
            // original string.
            str = ws + str;
        } else if (cursorNode.nodeType == 3 || !(cursorNode.wcNode ||
            cursorNode.tileNode ||
...
hterm.Terminal.prototype.onMouse_ = function (e) {
    ...
    if (!reportMouseEvents) {
        ...
        if (e.type == 'mouseup' && e.which == 1 && this.copyOnSelect && !this.document_.getSelection().isCollapsed) {
            this.copySelectionToClipboard(this.document_);
        }
...
hterm.TextAttributes.prototype.isDefault = function () {
    ...
    this.backgroundSource == this.SRC_DEFAULT && !this.bold && !this.faint && !this.italic && !this.blink && !this.underline && !this.strikethrough && !this.inverse && !this.invisible && !this.wcNode &&
    this.tileData == null);
};
...
hterm.TextAttributes.prototype.matchesContainer = function (obj) {
    ...
    return (!(this.wcNode || obj.wcNode) && !(this.tileData != null || obj.tileNode) &&
