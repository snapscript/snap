...
import org.snapscript.tree.AssertStatement;
import org.snapscript.tree.BreakStatement;
import org.snapscript.tree.Cast;
...
import org.snapscript.tree.ContinueStatement;
import org.snapscript.tree.DebugStatement;
import org.snapscript.tree.Declaration;
import org.snapscript.tree.DeclarationStatement;
...
import org.snapscript.tree.FullQualifier;
import org.snapscript.tree.Import;
import org.snapscript.tree.ImportList;
import org.snapscript.tree.ImportStatic;
import org.snapscript.tree.Modifier;
import org.snapscript.tree.ModifierList;
import org.snapscript.tree.ReturnStatement;
import org.snapscript.tree.Super;
import org.snapscript.tree.SynchronizedStatement;
import org.snapscript.tree.This;
import org.snapscript.tree.ThrowStatement;
import org.snapscript.tree.TryStatement;
import org.snapscript.tree.WildQualifier;
import org.snapscript.tree.YieldStatement;
...
import org.snapscript.tree.constraint.GenericParameterList;
...
public class GenerateInstructions {
   ...
   private static enum OldInstructionEnum {
      ...
      IMPORT_LIST(ImportList.class, "import-list"),
      ...
      private OldInstructionEnum(Class type, String name) {
         this.type = type;
         this.name = name;
      }
   }
   ...
   public static void main(String[] args) throws Exception {
      for(OldInstructionEnum e : OldInstructionEnum.values()){
         System.err.println(e.name + " = " + e.type.getName());
      }
   }
}
