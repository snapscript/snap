...
public class TokenReaderTest extends TestCase  {
   ...
   public void testMixText() throws Exception {
      ...
      assertEquals(decoder.literal("+x+"), "+x+");
      assertEquals(decoder.text(), "\nother stuff");
      assertEquals(decoder.literal("+"), "+");
      assertEquals(decoder.text(), "\nyet more");
      assertEquals(decoder.literal("+x"), "+x");
   ...
   public void testComments() throws Exception {
      ...
      assertEquals(decoder.next(),new Character(';'));      
   ...
   public void testNumbers() throws Exception {
      ...
      assertEquals(decoder1.next(), new Character(','));
      ...
      assertEquals(decoder2.next(), new Character(','));
   ...
   public void testDecoder() throws Exception {
      ...
      assertEquals(decoder.peek(), new Character(','));
      assertEquals(decoder.next(), new Character(','));
