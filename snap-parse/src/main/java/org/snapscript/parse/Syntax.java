...
public enum Syntax {
   ...
   REFERENCE_INVOCATION("reference-invocation", "<function-argument-list>"),
   REFERENCE_INDEX("reference-index", "<argument>"),
   REFERENCE("reference", "{<reference-type>|<reference-navigation>}"),
   REFERENCE_PART("reference-part", "{<collection-index>|<function-invocation>|<construct>|<closure>|<function-reference>|<variable-reference>|<literal>}"),
   ...
   CONSTRUCT_OBJECT("construct-object", "'new'_<type-reference>'('?<argument-list>')'"),
   CONSTRUCT_LIST("construct-list", "'[]'|'['<list-entry-list>']'"),
   CONSTRUCT_ARRAY("construct-array", "'new'_<type-reference>+('['<argument>']')"),
   ...
   ASSIGNMENT("assignment", "<reference>?_<assignment-operator>?_<expression>"),
   ...
   COMPARISON("comparison", "<comparison-operand>?_<comparison-operator>?_<comparison-operand>"),
   ...
   COMBINATION("combination", "{<conditional>|<conditional-operand>}?_<conditional-operator>?_<conditional>"),
   ...
   CALCULATION_LIST("calculation-list", "<calculation-operand>?_<calculation-operator>?_<calculation-operand>*(<calculation-operator><calculation-operand>)"),
   ...
   RETURN_STATEMENT("return-statement", "'return'*(?_{<expression>|<closure>})';'"),
   BREAK_STATEMENT("break-statement", "'break;'"),
   CONTINUE_STATEMENT("continue-statement", "'continue;'"),
   THROW_STATEMENT("throw-statement", "'throw'?_(<reference>|<literal>)';'"),
   ASSERT_STATEMENT("assert-statement", "'assert'?_<conditional>';'"),
   ...
   DECLARATION_STATEMENT("declaration-statement", "<declaration-modifier>_<declaration>*(','<declaration>)';'"),   
   ...
   IF_STATEMENT("if-statement", "'if('<conditional>')'<statement>?('else'?_<statement>)"),  
   ...
   FOR_IN_STATEMENT("for-in-statement", "'for('?('var'_)([identifier])_'in'?_{<range>|<reference>}')'<statement>"),
   ...
   CLOSURE("closure", "<closure-parameter-list>?_'->'?_{<group-statement>|<expression>}"),
   TYPE_NAME("type-name", "[type]"),
   TRAIT_NAME("trait-name", "[type]"),
   ANNOTATION_NAME("annotation-name", "[type]"),   
   ANNOTATION_LIST("annotation-list", "*<annotation-declaration>?_"),
   ...
   FIELD_MODIFIER_LIST("field-modifier-list", "*(<field-modifier>_)"),
   FUNCTION_MODIFIER("function-modifier", "{'static'|'public'|'private'|'abstract'|'override'}"),
   FUNCTION_MODIFIER_LIST("function-modifier-list", "*(<function-modifier>_)"),   
   ACCESS_MODIFIER("access-modifier", "{'public'|'private'}"),
   ACCESS_MODIFIER_LIST("access-modifier-list", "*(<access-modifier>_)"), 
   SUPER_CONSTRUCTOR("super-constructor", "'super('?<argument-list>')'"),
   THIS_CONSTRUCTOR("this-constructor", "'this('?<argument-list>')'"),
   CLASS_FIELD_DECLARATION("class-field-declaration", "<assignment-variable>?(':'<constraint>)?('='<assignment-expression>)"),
   CLASS_FIELD("class-field", "<annotation-list><field-modifier-list><class-field-declaration>*(','<class-field-declaration>)';'"),
   ...
   CLASS_HIERARCHY("class-hierarchy", "?{_'extends'_<type-reference>|_'with'_<trait-reference>}*(_'with'_<trait-reference>)"),
   CLASS_DEFINITION("class-definition", "?<annotation-list>'class'_<type-name>?<class-hierarchy>{'{}'|'{'*<class-part>'}'}"),
   TRAIT_CONSTANT("trait-constant", "<annotation-list><field-modifier-list><assignment-variable>?(':'<constraint>)'='<assignment-expression>';'"),
   TRAIT_HIERARCHY("trait-hierarchy", "*(_'extends'_<trait-reference>)"),
   ...
   TRAIT_DEFINITION("trait-definition", "?<annotation-list>'trait'_<trait-name>?<trait-hierarchy>{'{}'|'{'*<trait-part>'}'}"),   
   ENUM_HIERARCHY("enum-hierarchy", "*(_'with'_<trait-reference>)}"),
   ...
   ENUM_FIELD_DECLARATION("enum-field-declaration", "<assignment-variable>?(':'<constraint>)?('='<assignment-expression>)"),
   ENUM_FIELD("enum-field", "<annotation-list><field-modifier-list><enum-field-declaration>*(','<enum-field-declaration>)';'"),
   ...
   ENUM_DEFINITION("enum-definition", "?<annotation-list>'enum'_<type-name>?<enum-hierarchy>'{'<enum-list>?(';'*<enum-part>)'}'"),   
   ...
   IMPORT_STATIC("import-static", "'import static'_(<full-qualifier>|<wild-qualifier>)';'"),
   IMPORT("import", "'import'_(<full-qualifier>|<wild-qualifier>)?(' as '[type])';'"),   
   ...
   MODULE_DEFINITION("module-definition", "?<annotation-list>'module'_<module-name>{<empty-statement>|'{'*{<module-import>|<module-function>|<module-statement>}'}'}"),   
   SCRIPT_IMPORT("script-import", "<import-static>|<import>"),
   SCRIPT_FUNCTION("script-function", "'function'_<function>'('<parameter-list>')'?(':'<constraint>)<group-statement>"),
