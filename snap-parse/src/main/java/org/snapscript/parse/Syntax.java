...
public enum Syntax {
   ...
   SWITCH_CASE_STATEMENT("switch-case-statement", "*<statement>"),
   SWITCH_CASE("switch-case", "'case'?' '<value-operand>':'<switch-case-statement>"),
   SWITCH_DEFAULT("switch-default", "'default'':'<switch-case-statement>"),
